...
This is an utility extension for [Fetchr 5.3.3 by NeunEinser](https://github.com/NeunEinser/bingo/releases/tag/5.3.3) to allow switching between different item pools added by other extensions.
