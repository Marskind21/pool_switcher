...
This is an utility extension for [Fetchr by NeunEinser](https://github.com/NeunEinser/bingo) (see [release page](https://github.com/Marskind21/pool_switcher/releases) for compatibility information) to allow switching between different item pools added by other extensions.
