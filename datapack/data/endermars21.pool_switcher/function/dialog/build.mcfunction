...
execute if score @s endermars21.pool_switcher.change_pool matches -1 run return run function endermars21.pool_switcher:dialog/display with storage endermars21.pool_switcher:dialog
function endermars21.pool_switcher:dialog/display_from_sign with storage endermars21.pool_switcher:dialog
