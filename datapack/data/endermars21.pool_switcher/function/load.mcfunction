...
execute if score $lobby_generated fetchr.state matches 4 in fetchr:lobby unless entity @e[type=marker,tag=endermars21.pool_switcher.marker,distance=0..] run function #fetchr:lobby/generated
